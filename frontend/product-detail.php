    ...
    async function loadProductDetails() {
        try {
            ...
            if (result.status === "success" && result.data.length > 0) {
                ...
                const mainImage = images.length > 0 && images[0] ? `Johar_traders_uploads/product/${images[0]}` : 'Johar_traders_uploads/placeholder.png'; // Use placeholder if no image
                const thumbnails = images.length > 1 ? images : ['placeholder.png']; // Use placeholder if no other images
                ...
                thumbnails.forEach(thumbnail => {
                    ...
                    thumbElement.src = thumbnail ? `Johar_traders_uploads/product/${thumbnail}` : 'Johar_traders_uploads/placeholder.png'; // Fallback to placeholder if no image
                ...
                productNames.forEach(element => {
                    element.innerText = product.name || 'Product Name'; // Set the product name for each element
                });
                ...
                // Set WhatsApp link with dynamic product name
                const whatsappLink = document.getElementById("whatsappLink");
                const message = `I%20have%20a%20question%20about%20${encodeURIComponent(product.name)}`;
                whatsappLink.href = `https://wa.me/919831090825?text=${message}`;
            ...
            if (result.status === "success") {
                ...
                result.data.forEach(product => {
                    ...
                    const firstImage = rlProductimages.length > 0 && rlProductimages[0] 
                        ...
                        : 'Johar_traders_uploads/placeholder.png'; // Use placeholder if no image
...
<div class="body_section">
    ...
    <div class="max-w-7xl mx-auto mt-5 px-5">
        <nav class="text-sm text-gray-600">
            ...
            <span class="text-gray-800 productName">Product Name</span> <!-- Initially placeholder for the name -->
        </nav>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
                ...
                <div>
                    ...
                    <div class="mb-4 overflow-hidden rounded-lg">
                        <img id="mainImage" src="Johar_traders_uploads/placeholder.png" 
                ...
                <div>
                    ...
                    <!-- WhatsApp Button -->
                    <div class="whatsapp-button-container mt-6 w-[270px]">
                        <a id="whatsappLink" href="#" class="whatsapp-button flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors">
                            <!-- FontAwesome WhatsApp Icon -->
                            <i class="fab fa-whatsapp w-9 h-10" style="font-size: 40px;"></i> <!-- WhatsApp Icon -->
                            
                            <!-- Text Content -->
                            <div class="whatsapp-text">
                                <span class="text-sm">
                                    <span class="font-semibold">Johar Traders /</span>
                                    <span class="text-sm">S Akberally</span>
                                </span>
                                <br>
                                <span class="text-sm">Have a query? Chat now</span>
                            </div>
                        </a>
                    </div>
